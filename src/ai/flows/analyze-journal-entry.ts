...
const analyzeJournalEntryPrompt = ai.definePrompt({
  ...
  prompt: `Analiza la siguiente entrada de diario e identifica temas clave, sentimiento general y cualquier patrón recurrente en los pensamientos y emociones del usuario. Además, proporciona un resumen de la entrada del diario.
